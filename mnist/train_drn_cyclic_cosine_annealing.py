...
def evaluate(model, val_loader, lr_scheduler, device, step):
    model.eval()
    val_ae_loss_list = []
    val_ucc_loss_list = []
    val_acc_list = []
...
if __name__ == "__main__":
    ...
    lr_scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer, 10000, 1, eta_min=0.00005)
    cfg_name = "train_drn"
    ...
    mlflow.set_experiment(experiment_name="cyclic_cosine_annealing")
